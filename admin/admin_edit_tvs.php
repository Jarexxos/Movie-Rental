<?php
	...
	// get book data
	$query = "SELECT * FROM tvs WHERE id = '$tvs_id'";
...
?><div class="container">
	...
	<form method="post" action="edit_tvs.php" enctype="multipart/form-data">
		<table class="table">
			<tr>
				<th>ID</th>
			...
			<tr>
				<th>Reżyser</th>
				<td><input type="text" name="studio" value="<?php echo $row['studio'];?>" required></td>
			</tr>
			<tr>
				<th>Miniatruka</th>
	...
	<br/>
            <a href="admin_tvs.php" class="btn btn-primary"><i class="fas fa-backward"></i> Powrót</a></div></div>
<?php
