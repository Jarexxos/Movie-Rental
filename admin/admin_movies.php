...
?>
	...
	<p class="lead"><br><a href="admin_add_movies.php" class="btn btn-success">
	<i class="fas fa-plus-circle"></i> Dodaj nowy film</a></p>
	...
	<table class="table" style="margin-top: 20px">
		...
		<tr>
			...
			<td><?php echo $row['rezyser']; ?></td>
			<td><?php echo $row['img']; ?></td>
            <td class="tekst"><?php echo $row['opis']; ?></td>
			<td><?php echo $row['cena']; ?></td>
			<td><?php echo $row['premiera']; ?></td>
			<td><a href="admin_edit_movies.php?id=<?php echo $row['id']; ?>">
            <i class="fas fa-edit" style="color: orange";></i>    
            </a></td>
			<td><a href="admin_delete_movies.php?id=<?php echo $row['id']; ?>">
    ...
    <a href="admin_logout.php" class="btn btn-danger"><i class="fas fa-sign-out-alt"></i>
    Wyloguj!</a><br><br>
