...
?>
	...
	<p class="lead"><br><a href="admin_add_series.php" class="btn btn-success">
	<i class="fas fa-plus-circle"></i> Dodaj nowy serial</a></p>
	...
	<table class="table" style="margin-top: 20px">
		...
		<tr>
			...
			<td><?php echo $row['tworca']; ?></td>
			<td><?php echo $row['img']; ?></td>
			<td class="tekst"><?php echo $row['opis']; ?></td>
			<td><?php echo $row['cena']; ?></td>
			<td><?php echo $row['premiera']; ?></td>
			<td><a href="admin_edit_series.php?id=<?php echo $row['id']; ?>">
                <i class="fas fa-edit" style="color: orange";></i>
                </a></td>
			<td><a href="admin_delete_series.php?id=<?php echo $row['id']; ?>">
