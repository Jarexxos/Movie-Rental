...
?>
	...
	<form method="post" action="edit_series.php" enctype="multipart/form-data">
		<table class="table">
			<tr>
				<th>ID</th>
			...
			<tr>
				<th>Twórca</th>
				<td><input type="text" name="tworca" value="<?php echo $row['tworca'];?>" required></td>
			</tr>
			<tr>
				<th>Miniatruka</th>
	...
	<br/>
            <a href="admin_series.php" class="btn btn-primary"><i class="fas fa-backward"></i> Powrót</a></div></div>
<?php
