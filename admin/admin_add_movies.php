<?php
	...
	if(isset($_POST['add'])){
		...
		$rezyser = mysqli_real_escape_string($conn, $rezyser);
		...
		$query = "INSERT INTO movies VALUES ('" . $id . "', '" . $tytul . "', '" . $rezyser . "', '" . $image . "', '" . $opis . "', '" . $cena . "', '" . $premiera . "')";
...
?>
	...
	<form method="post" action="admin_add_movies.php" enctype="multipart/form-data">
		<table class="table">
			<tr>
				<th>ID </th>
				<td><input type="text" name="id" placeholder="AUTO INCREMENT" disabled></td>
			</tr>
			<tr>
				<th>Tytuł</th>
			...
			<tr>
				<th>Reżyser</th>
				<td><input type="text" name="rezyser" required></td>
			</tr>
			<tr><th>Miniaturka (../img/movies)</th>
