...
include_once("db_login.php");
  ...
  $query = "SELECT tytul, tworca, cena, opis, img, premiera FROM series WHERE id = '$id'";
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
     ...
     <div class="container">
      ...
      <p class="lead" style="margin: 25px 0"><a href="series.php">Seriale</a> > <?php echo $row['tytul']; ?></p>
      <div class="row">
        <div class="col-md-3 text-center">
          <img class="img-responsive img-thumbnail" src="img/series/<?php echo $row['img']; ?>">
        </div>
        <div class="col-md-6">
          <h4>Opis serialu</h4>
