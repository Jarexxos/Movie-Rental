...
include_once("db_login.php");
  ...
  $query = "SELECT tytul, studio, cena, opis, img, premiera FROM tvs WHERE id = '$id'";
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
     ...
     <div class="container">
      ...
      <p class="lead" style="margin: 25px 0"><a href="tvs.php">Programy TV</a> > <?php echo $row['tytul']; ?></p>
      <div class="row">
        <div class="col-md-3 text-center">
          <img class="img-responsive img-thumbnail" src="img/tvs/<?php echo $row['img']; ?>">
        </div>
        <div class="col-md-6">
          <h4>Opis programu TV</h4>
